...
import { calcularTarifa, DatosCalculo, ResultadoCalculo } from '@/lib/calculos';
                            ...
                            {resultado && (
                              <>
                                <div>
                                  ...
                                  <MultiCurrencyDisplay valueCLP={resultado.tarifaHora} className="text-xs mt-1" />
                                </div>
                                <div>
                                  <span className="block text-xs text-gray-500">Tarifa por proyecto (40h)</span>
                                  <MultiCurrencyDisplay valueCLP={resultado.tarifaProyecto} className="text-xs mt-1" />
                                </div>
                                <div>
                                  <span className="block text-xs text-gray-500">Ingresos netos</span>
                                  <MultiCurrencyDisplay valueCLP={resultado.ingresosNetos} className="text-xs mt-1" />
                                </div>
                              </>
                            )}
                          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {defaultTemplates.map((template) => (
                    ...
                    >
                      ...
                      <MultiCurrencyDisplay valueCLP={template.result?.tarifaProyecto ?? 0} className="text-xs mt-2" />
                    </div>
                  ))}
                </div>
              </div>
