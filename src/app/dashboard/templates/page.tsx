                ...
                >
                  ...
                  <div className="space-y-3 mb-4">
                    ...
                    <div className="flex items-center justify-between text-xs text-gray-500">
                      ...
                      {template.is_default && (
                        <span className="text-blue-600 font-medium">Por defecto</span>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="flex space-x-2">
                    <button
                      ...
                      className="flex-1 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 shadow-sm hover:shadow-md transform hover:-translate-y-0.5"
                    >
                      Usar Template
                    </button>
                    {activeTab === 'my' && (
